$(function() {
     ...
     */
    Media.prototype.canPlayType = function(source) {
     ...
     * @return this
     */
    Media.prototype.ready = function(fn) {
     ...
     */
    Media.prototype.readyState = function(state, fn) {
     ...
     * @return boolean/number (for getters)
     */
    Media.prototype.networkState = function(state) {
        if (arguments.length === 0) {
     ...
     */
    Media.prototype.source = function(sources) {
     ...
     * @return this (for setter)
     */
    Media.prototype.loop = function(value) {
        if (arguments.length === 0) {
     ...
     * @return this (for setter)
     */
    Media.prototype.autoplay = function(value) {
     ...
     * @return this (for setter)
     */
    Media.prototype.controls = function(value) {
        if (arguments.length === 0) {
     ...
     * @return this (for setter)
     */
    Media.prototype.poster = function(value) {
        if (arguments.length === 0) {
     ...
     * @return this (for setter)
     */
    Media.prototype.preload = function(value) {
        if (arguments.length === 0) {
     ...
     * @return this
     */
    Media.prototype.muted = function(fn) {
    ...
    Media.prototype.on = function(event, fn) {
        var registeredEvents = this.$element.data('events') || {},
            events = event.toLowerCase().split(' '),
            i, length = events.length,
            that = this;
    ...
    Media.prototype.off = function(event, fn) {
        var events = event.toLowerCase().split(' '),
            i, length = events.length;
     ...
     * @return this
     */
    Media.prototype.triggerHandler = function(event, data) {
        switch (event) {
            case 'seek':
    ...
    Media.prototype.time = function(time) {
        if (arguments.length === 0) {
            return toSeconds(this.element.currentTime);
        }
        ...
        if (typeof time === 'string') {
            if (time.indexOf('+') === 0) {
                ...
                time = toSeconds((this.duration() / 100) * parseFloat(time));
            }
        } else {
            time = toSeconds(time);
        }
     ...
     * @return this On bind event
     */
    Media.prototype.duration = function(fn) {
        if ($.isFunction(fn)) {
            return this.on('durationchange', fn);
        }

        return toSeconds(this.element.duration || 0);
    };
     ...
     */
    Media.prototype.data = function(name, value) {
        if (value === undefined) {
     ...
     */
    function createVideo(properties) {
        if (typeof properties === 'string' || $.isArray(properties)) {
            properties = { src: properties };
        }

        return create('<video>', properties);
    };
     ...
     * @return The Media instance
     */
    function createAudio(properties) {
        if (typeof properties === 'string' || $.isArray(properties)) {
            properties = { src: properties };
        }

        return create('<audio>', properties);
    };


    /**
     * Convert any number or string to seconds
     *
     * @param string|number
     *
    ...
    function toSeconds(time) {
        ...
        return toSeconds(parseFloat(time));
    };


    /**
     * Format any number or string
     *
     * @param string|number
     * @param string outputFormat ('ms', 'ss', 'mm:ss', 'hh:mm:ss', 'hh:mm:ss.ms')
     *
     * @return string
     */
    function secondsTo(time, outputFormat) {
        if (typeof time === 'string') {
            time = toSeconds(time);
        }
